...
namespace SVAuth
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            // properties should match. ~ REDACTED 2016-06-01
            Config.Init();
            Utils.InitForReal();
            SVX.SVX_Ops.Init();
        ...
        private static void RunAgent()
        {
            ...
            // calls (which generate something similar) ~ REDACTED 2016-06-15
            ...
            var host = new WebHostBuilder()
                ...
                // let's set it correctly. ~ REDACTED 2016-06-02
                .UseUrls(urls)
        ...
        // BCT WORKAROUND: lambdas ~ REDACTED 2016-06-15
